...
public class CustomerDaoImpl implements CustomerDao{
	...
	public boolean insert(Customer obj) throws SQLException {
		...
		st.setString(2, obj.getCustomerEmailId());
		st.setString(3, obj.getCustomerContactNumber());
		st.setString(4, obj.getCustomerAddress());
	...
	public boolean modify(Customer obj) throws SQLException, CustomerNotFoundException {
		...
		//st.setInt(1, obj.getC_Id());
		st.setString(1, obj.getCustomerName());
		st.setString(2,obj.getCustomerContactNumber());
		st.setString(3,obj.getCustomerEmailId());
		st.setString(4,obj.getCustomerAddress());
